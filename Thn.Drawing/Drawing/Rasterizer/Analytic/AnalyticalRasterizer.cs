...
namespace Thn.Drawing.Rasterizers.Analytical
{
    ...
    /// </para>
    /// </summary>
    /*internal*/ public  abstract class AnalyticalRasterizerBase : AnalyticalAlgorithmImplement,IPolygonRasterizer
    {
        ...
        protected virtual void OnFilling(PaintMaterial paint, RowData[] rows, int startYIndex, int endYIndex)
        {
            ...
            if (IsClipBoxOutSideBound) return;
            //Thn.Log.Debug("Start row {0}, end rows {1}",startYIndex,endYIndex);
        ...
        {
            AlphaCache = Thn.Drawing.AlphaCache.Cache;
