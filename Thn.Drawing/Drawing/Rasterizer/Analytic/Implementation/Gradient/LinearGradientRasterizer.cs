                                        ...
                                        else
                                        {
                                            while (startXPosition < lastXPosition)
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    BufferData[startXPosition] =
                                                        (uint)((AlphaCache[(((dst >> 24) & 0xFF) << 8) + calculatedCoverage])
                                                        | ((gammaLutGreen[(((((((colorData & 0x00FF00) >> 8) - dstG) * calculatedCoverage) >> 8) + dstG) & 0xFF)] << 8))
                                                        | (gammaLutRed[(dstRB & 0x00FF0000) >> 16] << 16)
                                        ...
                                        else
                                        {
                                            while (startXPosition < lastXPosition)
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    BufferData[startXPosition] =
                                                        (uint)((AlphaCache[(((dst >> 24) & 0xFF) << 8) + calculatedCoverage])
                                                        | ((gammaLutGreen[(((((colorG - dstG) * calculatedCoverage) >> 8) + dstG) & 0xFF)] << 8))
                                                        | (gammaLutRed[(dstRB & 0x00FF0000) >> 16] << 16)
                                                        | (gammaLutBlue[(dstRB & 0x00FF)]));
                                                    #endregion
                                                    #endregion
                                            ...
                                            else
                                            {
                                                while (startXPosition < lastXPosition)
                                                {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        BufferData[startXPosition] =
                                                            (uint)((AlphaCache[(((dst >> 24) & 0xFF) << 8) + calculatedCoverage])
                                                            | ((gammaLutGreen[(((((((colorData & 0xFF00) >> 8) - dstG) * calculatedCoverage) >> 8) + dstG) & 0xFF)] << 8))
                                                            | (gammaLutRed[(dstRB & 0x00FF0000) >> 16] << 16)
                                                            | (gammaLutBlue[(dstRB & 0x00FF)]));
                                                        #endregion
                                                    }
