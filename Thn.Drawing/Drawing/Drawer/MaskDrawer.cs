...
using Thn.Drawing.Rasterizers.Analytical;
#endregion
...
namespace Thn.Drawing
{
    ...
    public class MaskDrawer : IDrawer
    {
        ...
        void Prepare()
        {
            if (mBuffer == null) Thn.Exceptions.NullArgumentException.Publish("Buffer");
        ...
        public void Load(object state)
        {
            ...
            else Thn.Exceptions.IncompatibleTypeException.Publish(state, typeof(DrawerState));
        }
        #endregion
        ...
        public bool GammaCorrected
        {
            ...
            set
            {
                Thn.Exceptions.UnsupportedException.Publish("Gamma correction", "MaskDrawer");
            }
        }
        #endregion
